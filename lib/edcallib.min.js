var humanMsg={setup:function(a,b,d){humanMsg.msgID="humanMsg";humanMsg.logID="humanMsgLog";a="body";if(b==undefined)b=humanMsg.logTitle==undefined?"Message Log":humanMsg.logTitle;humanMsg.logTop=jQuery("#"+humanMsg.logID).css("top");humanMsg.msgOpacity=0.9;if(d!=undefined)humanMsg.msgOpacity=parseFloat(d);jQuery(a).prepend('<div id="'+humanMsg.msgID+'" class="humanMsg"><div class="round"></div><p></p><div class="round"></div></div>');jQuery(a).append('<div id="'+humanMsg.logID+'"><p>'+b+'</p><a href="#" id="humanMsgClose">x</a><ul></ul></div>');
