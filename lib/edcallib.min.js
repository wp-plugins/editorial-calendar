...
/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,e,g,i={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},k;function m(f){d.lastIndex=0;return d.test(f)?'"'+f.replace(d,function(j){var n=i[j];return typeof n==="string"?n:"\\u"+("0000"+j.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+f+'"'}function h(f,j){var n,q,s=e,t,p=j[f];if(p&&typeof p==="object"&&typeof p.toJSON==="function")p=p.toJSON(f);
if(typeof k==="function")p=k.call(j,f,p);switch(typeof p){case "string":return m(p);case "number":return isFinite(p)?String(p):"null";case "boolean":case "null":return String(p);case "object":if(!p)return"null";e+=g;t=[];if(Object.prototype.toString.apply(p)==="[object Array]"){q=p.length;for(f=0;f<q;f+=1)t[f]=h(f,p)||"null";j=t.length===0?"[]":e?"[\n"+e+t.join(",\n"+e)+"\n"+s+"]":"["+t.join(",")+"]";e=s;return j}if(k&&typeof k==="object"){q=k.length;for(f=0;f<q;f+=1){n=k[f];if(typeof n==="string")if(j=
h(n,p))t.push(m(n)+(e?": ":":")+j)}}else for(n in p)if(Object.hasOwnProperty.call(p,n))if(j=h(n,p))t.push(m(n)+(e?": ":":")+j);j=t.length===0?"{}":e?"{\n"+e+t.join(",\n"+e)+"\n"+s+"}":"{"+t.join(",")+"}";e=s;return j}}if(typeof JSON.stringify!=="function")JSON.stringify=function(f,j,n){var q;g=e="";if(typeof n==="number")for(q=0;q<n;q+=1)g+=" ";else if(typeof n==="string")g=n;if((k=j)&&typeof j!=="function"&&(typeof j!=="object"||typeof j.length!=="number"))throw new Error("JSON.stringify");return h("",
{"":f})};if(typeof JSON.parseIt!=="function")JSON.parseIt=function(f,j){function n(q,s){var t,p,u=q[s];if(u&&typeof u==="object")for(t in u)if(Object.hasOwnProperty.call(u,t)){p=n(u,t);if(p!==undefined)u[t]=p;else delete u[t]}return j.call(q,s,u)}c.lastIndex=0;if(c.test(f))f=f.replace(c,function(q){return"\\u"+("0000"+q.charCodeAt(0).toString(16)).slice(-4)});if(/^[\],:{}\s]*$/.test(f.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
...
l);k.trigger("onSeek",[l])}m?h.animate({left:-w.position().left},o,g.easing,z):h.animate({top:-w.position().top},o,g.easing,z);c=i;f=l;y=b.Event("onStart");k.trigger(y,[l]);if(y.isDefaultPrevented())return i;q.add(t).toggleClass(g.disabledClass,l===0);s.add(p).toggleClass(g.disabledClass,l>=i.getSize()-g.size);return i},move:function(l,o,v){j=l>0;return this.seekTo(f+l,o,v)},next:function(l,o){return this.move(1,l,o)},prev:function(l,o){return this.move(-1,l,o)},movePage:function(l,o,v){j=l>0;var w=
...
function(l,o){i[o]=function(v){return i.bind(o,v)}});q.addClass(g.disabledClass).click(function(){i.prev()});s.click(function(){i.next()});p.click(function(){i.nextPage()});i.getSize()<g.size&&s.add(p).addClass(g.disabledClass);t.addClass(g.disabledClass).click(function(){i.prevPage()});var u=g.hoverClass,x="keydown."+Math.random().toString().substring(10);i.onReload(function(){u&&i.getItems().hover(function(){b(this).addClass(u)},function(){b(this).removeClass(u)});g.clickable&&i.getItems().each(function(l){b(this).unbind("click.scrollable").bind("click.scrollable",
...
!f.length?b(document):f}});b.extend(b.expr[":"],{data:function(f,j,n){return!!b.data(f,n[3])},focusable:function(f){var j=f.nodeName.toLowerCase(),n=b.attr(f,"tabindex");return(/input|select|textarea|button|object/.test(j)?!f.disabled:"a"==j||"area"==j?f.href||!isNaN(n):!isNaN(n))&&!b(f)["area"==j?"parents":"closest"](":hidden").length},tabbable:function(f){var j=b.attr(f,"tabindex");return(isNaN(j)||j>=0)&&b(f).is(":focusable")}});function h(f,j,n,q){function s(p){p=b[f][j][p]||[];return typeof p==
"string"?p.split(/,?\s+/):p}var t=s("getter");if(q.length==1&&typeof q[0]=="string")t=t.concat(s("getterSetter"));return b.inArray(n,t)!=-1}b.widget=function(f,j){var n=f.split(".")[0];f=f.split(".")[1];b.fn[f]=function(q){var s=typeof q=="string",t=Array.prototype.slice.call(arguments,1);if(s&&q.substring(0,1)=="_")return this;if(s&&h(n,f,q,t)){var p=b.data(this[0],f);return p?p[q].apply(p,t):undefined}return this.each(function(){var u=b.data(this,f);!u&&!s&&b.data(this,f,new b[n][f](this,q))._init();
u&&s&&b.isFunction(u[q])&&u[q].apply(u,t)})};b[n]=b[n]||{};b[n][f]=function(q,s){var t=this;this.namespace=n;this.widgetName=f;this.widgetEventPrefix=b[n][f].eventPrefix||f;this.widgetBaseClass=n+"-"+f;this.options=b.extend({},b.widget.defaults,b[n][f].defaults,b.metadata&&b.metadata.get(q)[f],s);this.element=b(q).bind("setData."+f,function(p,u,x){if(p.target==q)return t._setData(u,x)}).bind("getData."+f,function(p,u){if(p.target==q)return t._getData(u)}).bind("remove",function(){return t.destroy()})};
b[n][f].prototype=b.extend({},b.widget.prototype,j);b[n][f].getterSetter="option"};b.widget.prototype={_init:function(){},destroy:function(){this.element.removeData(this.widgetName).removeClass(this.widgetBaseClass+"-disabled "+this.namespace+"-state-disabled").removeAttr("aria-disabled")},option:function(f,j){var n=f,q=this;if(typeof f=="string"){if(j===undefined)return this._getData(f);n={};n[f]=j}b.each(n,function(s,t){q._setData(s,t)})},_getData:function(f){return this.options[f]},_setData:function(f,
j){this.options[f]=j;if(f=="disabled")this.element[j?"addClass":"removeClass"](this.widgetBaseClass+"-disabled "+this.namespace+"-state-disabled").attr("aria-disabled",j)},enable:function(){this._setData("disabled",false)},disable:function(){this._setData("disabled",true)},_trigger:function(f,j,n){var q=this.options[f];f=f==this.widgetEventPrefix?f:this.widgetEventPrefix+f;j=b.Event(j);j.type=f;if(j.originalEvent){f=b.event.props.length;for(var s;f;){s=b.event.props[--f];j[s]=j.originalEvent[s]}}this.element.trigger(j,
n);return!(b.isFunction(q)&&q.call(this.element[0],j,n)===false||j.isDefaultPrevented())}};b.widget.defaults={disabled:false};b.ui.mouse={_mouseInit:function(){var f=this;this.element.bind("mousedown."+this.widgetName,function(j){return f._mouseDown(j)}).bind("click."+this.widgetName,function(j){if(f._preventClickEvent){f._preventClickEvent=false;j.stopImmediatePropagation();return false}});if(b.browser.msie){this._mouseUnselectable=this.element.attr("unselectable");this.element.attr("unselectable",
"on")}this.started=false},_mouseDestroy:function(){this.element.unbind("."+this.widgetName);b.browser.msie&&this.element.attr("unselectable",this._mouseUnselectable)},_mouseDown:function(f){f.originalEvent=f.originalEvent||{};if(!f.originalEvent.mouseHandled){this._mouseStarted&&this._mouseUp(f);this._mouseDownEvent=f;var j=this,n=f.which==1,q=typeof this.options.cancel=="string"?b(f.target).parents().add(f.target).filter(this.options.cancel).length:false;if(!n||q||!this._mouseCapture(f))return true;
...
e.snapElements.length-1;j>=0;j--){var n=e.snapElements[j].left,q=n+e.snapElements[j].width,s=e.snapElements[j].top,t=s+e.snapElements[j].height;if(n-i<k&&k<q+i&&s-i<h&&h<t+i||n-i<k&&k<q+i&&s-i<f&&f<t+i||n-i<m&&m<q+i&&s-i<h&&h<t+i||n-i<m&&m<q+i&&s-i<f&&f<t+i){if(g.snapMode!="inner"){var p=Math.abs(s-f)<=i,u=Math.abs(t-h)<=i,x=Math.abs(n-m)<=i,l=Math.abs(q-k)<=i;if(p)d.position.top=e._convertPositionTo("relative",{top:s-e.helperProportions.height,left:0}).top-e.margins.top;if(u)d.position.top=e._convertPositionTo("relative",
{top:t,left:0}).top-e.margins.top;if(x)d.position.left=e._convertPositionTo("relative",{top:0,left:n-e.helperProportions.width}).left-e.margins.left;if(l)d.position.left=e._convertPositionTo("relative",{top:0,left:q}).left-e.margins.left}var o=p||u||x||l;if(g.snapMode!="outer"){p=Math.abs(s-h)<=i;u=Math.abs(t-f)<=i;x=Math.abs(n-k)<=i;l=Math.abs(q-m)<=i;if(p)d.position.top=e._convertPositionTo("relative",{top:s,left:0}).top-e.margins.top;if(u)d.position.top=e._convertPositionTo("relative",{top:t-e.helperProportions.height,
left:0}).top-e.margins.top;if(x)d.position.left=e._convertPositionTo("relative",{top:0,left:n}).left-e.margins.left;if(l)d.position.left=e._convertPositionTo("relative",{top:0,left:q-e.helperProportions.width}).left-e.margins.left}if(!e.snapElements[j].snapping&&(p||u||x||l||o))e.options.snap.snap&&e.options.snap.snap.call(e.element,c,b.extend(e._uiHash(),{snapItem:e.snapElements[j].item}));e.snapElements[j].snapping=p||u||x||l||o}else{e.snapElements[j].snapping&&e.options.snap.release&&e.options.snap.release.call(e.element,
...
b(d.helper);d=b(this).data("draggable").options;if(c.css("zIndex"))d._zIndex=c.css("zIndex");c.css("zIndex",d.zIndex)},stop:function(c,d){c=b(this).data("draggable").options;c._zIndex&&b(d.helper).css("zIndex",c._zIndex)}})})(jQuery);(function(b){b.tools=b.tools||{};b.tools.scrollable={version:"1.1.2",conf:{size:5,vertical:false,speed:400,keyboard:true,keyboardSteps:null,disabledClass:"disabled",hoverClass:null,clickable:true,activeClass:"active",easing:"swing",loop:false,items:".items",item:null,prev:".prev",next:".next",prevPage:".prevPage",nextPage:".nextPage",api:false}};var c;function d(e,g){var i=this,k=b(this),m=!g.vertical,h=e.children(),f=0,j;c||(c=i);b.each(g,function(l,o){b.isFunction(o)&&k.bind(l,o)});if(h.length>
1)h=b(g.items,e);function n(l){var o=b(l);return g.globalNav?o:e.parent().find(l)}e.data("finder",n);var q=n(g.prev),s=n(g.next),t=n(g.prevPage),p=n(g.nextPage);b.extend(i,{getIndex:function(){return f},getClickIndex:function(){var l=i.getItems();return l.index(l.filter("."+g.activeClass))},getConf:function(){return g},getSize:function(){return i.getItems().size()},getPageAmount:function(){return Math.ceil(this.getSize()/g.size)},getPageIndex:function(){return Math.ceil(f/g.size)},getNaviButtons:function(){return q.add(s).add(t).add(p)},
...
m.data("navi")==i){m.empty();m.data("navi",i);for(var n=0;n<i.getPageAmount();n++)m.append(b("<"+(d.naviItem||"a")+"/>"));h=m.children().each(function(q){var s=b(this);s.click(function(t){i.setPage(q);return t.preventDefault()});d.indexed&&s.text(q);d.idPrefix&&s.attr("id",d.idPrefix+q)})}else{h=d.naviItem?m.find(d.naviItem):m.children();h.each(function(q){var s=b(this);s.click(function(t){i.setPage(q);return t.preventDefault()})})}h.eq(0).addClass(d.activeClass)}i.onStart(function(){var n=d.activeClass;
...
g.wheelDelta/120;break}g.type="wheel";return b.event.handle.call(this,g,g.delta)}var e=b.tools.scrollable;e.plugins=e.plugins||{};e.plugins.mousewheel={version:"1.0.1",conf:{api:false,speed:50}};b.fn.mousewheel=function(g){var i=b.extend({},e.plugins.mousewheel.conf),k;if(typeof g=="number")g={speed:g};g=b.extend(i,g);this.each(function(){var m=b(this).scrollable();if(m)k=m;m.getRoot().wheel(function(h,f){m.move(f<0?1:-1,g.speed||50);return false})});return g.api?k:this}})(jQuery);(function(b){b.widget("ui.droppable",{_init:function(){var c=this.options,d=c.accept;this.isover=0;this.isout=1;this.options.accept=this.options.accept&&b.isFunction(this.options.accept)?this.options.accept:function(e){return e.is(d)};this.proportions={width:this.element[0].offsetWidth,height:this.element[0].offsetHeight};b.ui.ddmanager.droppables[this.options.scope]=b.ui.ddmanager.droppables[this.options.scope]||[];b.ui.ddmanager.droppables[this.options.scope].push(this);this.options.addClasses&&
...
if(i.length){g=b.data(i[0],"droppable");g.greedyChild=e=="isover"?1:0}}if(g&&e=="isover"){g.isover=0;g.isout=1;g._out.call(g,d)}this[e]=1;this[e=="isout"?"isover":"isout"]=0;this[e=="isover"?"_over":"_out"].call(this,d);if(g&&e=="isout"){g.isout=0;g.isover=1;g._over.call(g,d)}}}})}}})(jQuery);(function(b){var c={},d,e,g,i="auto",k=b.browser.msie&&/MSIE\s(5\.5|6\.)/.test(navigator.userAgent),m=false;b.tooltip={blocked:false,defaults:{delay:200,fade:false,showURL:true,extraClass:"",top:15,left:15,id:"tooltip"},block:function(){b.tooltip.blocked=!b.tooltip.blocked}};b.fn.extend({tooltip:function(p){p=b.extend({},b.tooltip.defaults,p);h(p);return this.each(function(){b.data(this,"tooltip",p);this.tOpacity=c.parent.css("opacity")}).mouseover(n).mouseup(function(){q()})},hideWhenEmpty:function(){return this.each(function(){b(this)[b(this).html()?
"show":"hide"]()})},url:function(){return this.attr("href")||this.attr("src")}});function h(p){if(!c.parent){c.parent=b('<div id="'+p.id+'"><h3></h3><div class="body"></div><div class="url"></div></div>').appendTo(document.body).hide();b.fn.bgiframe&&c.parent.bgiframe();c.body=b("div.body",c.parent)}}function f(p){if(p)return b.data(p,"tooltip");else b("#tooltip").hide()}function j(p){m=!!f(this).track;b(document.body).bind("mousemove",s);s(p)}function n(){if(!(b.tooltip.blocked||this==d||!this.tooltipText&&
!f(this).bodyHandler)){d=this;j.apply(d,arguments)}}function q(){if(f(d)){c.parent.css({left:g,right:i,top:e});var p=t(),u=c.parent[0];if(g+200>p.x+p.cx){g-=u.offsetWidth+f(d).left+(g+225-(p.x+p.cx));c.parent.css({left:g+"px"}).addClass("viewport-right")}if(e+100>p.y+p.cy){e-=u.offsetHeight+100+f(d).top;c.parent.css({top:e+"px"}).addClass("viewport-bottom")}if(p.x+p.cx<u.offsetLeft+u.offsetWidth){g-=u.offsetWidth+20+f(d).left+150;c.parent.css({left:g+"px"}).addClass("viewport-right")}if(p.y+p.cy<
u.offsetTop+u.offsetHeight){e-=u.offsetHeight+20+f(d).top;c.parent.css({top:e+"px"}).addClass("viewport-bottom")}if(f(d).bodyHandler){p=f(d).bodyHandler.call(d);p.nodeType||p.jquery?c.body.empty().append(p):c.body.html(p);c.body.show()}else if(f(d).showBody){p=f(d).showBody;c.body.empty();u=0;for(var x;x=p[u];u++){u>0&&c.body.append("<br/>");c.body.append(x)}c.body.hideWhenEmpty()}else c.body.hide();c.parent.addClass(f(d).extraClass);f(d).fixPNG&&c.parent.fixPNG();if(f(d)){if((!k||!b.fn.bgiframe)&&
f(d).fade)if(c.parent.is(":animated"))c.parent.stop().show().fadeTo(f(d).fade,d.tOpacity);else c.parent.is(":visible")?c.parent.fadeTo(f(d).fade,d.tOpacity):c.parent.fadeIn(f(d).fade);else c.parent.show();f(d).showHandler&&f(d).showHandler.call(d)}}}function s(p){if(!b.tooltip.blocked)if(f(d))if(!(p&&p.target.tagName=="OPTION")){!m&&c.parent.is(":visible")&&b(document.body).unbind("mousemove",s);if(d==null)b(document.body).unbind("mousemove",s);else{c.parent.removeClass("viewport-right").removeClass("viewport-bottom");
g=c.parent[0].offsetLeft;e=c.parent[0].offsetTop;if(p){g=p.pageX+f(d).left;e=p.pageY+f(d).top;i="auto";if(f(d).positionLeft){i=b(window).width()-left;g="auto"}}}}}function t(){return{x:b(window).scrollLeft(),y:b(window).scrollTop(),cx:b(window).width(),cy:b(window).height()}}})(jQuery);
