 ...
 *
 * jQueryLastChangedDate: 2007-06-22 04:38:37 +0200 (Fr, 22 Jun 2007) jQuery
 * jQueryRev: 2141 jQuery
 *
 * Version: 1.0b2
 */
...
jQuery.fn.extend({
	...
	position: function(options, returnObject) {
		var elem = this[0], parent = elem.parentNode, op = elem.offsetParent,
		    options = jQuery.extend({ margin: false, border: false, padding: false, scroll: false }, options || {}),
			x = elem.offsetLeft,
			y = elem.offsetTop, 
			sl = elem.scrollLeft, 
			st = elem.scrollTop;
	...
	offset: function(options, returnObject) {
		var x = 0, y = 0, sl = 0, st = 0,
		    elem = this[0], parent = this[0], op, parPos, elemPos = jQuery.css(elem, 'position'),
		    mo = jQuery.browser.mozilla, ie = jQuery.browser.msie, sf = jQuery.browser.safari, oa = jQuery.browser.opera,
		    absparent = false, relparent = false, 
		    options = jQuery.extend({ margin: true, border: false, padding: false, scroll: true, lite: false }, options || {});
		...
		if (elem.tagName.toLowerCase() == 'body') {
			...
			do {
				parPos = jQuery.css(parent, 'position');
				...
				if (options.scroll || mo) {
					do {
						...
						// Mozilla does not add the border for a parent that has overflow set to anything but visible
						if (mo && parent != elem && jQuery.css(parent, 'overflow') != 'visible') {
							x += num(parent, 'borderLeftWidth');
							y += num(parent, 'borderTopWidth');
						}
				...
				if (parent.tagName.toLowerCase() == 'body' || parent.tagName.toLowerCase() == 'html') {
					...
					if ((sf || (ie && jQuery.boxModel)) && elemPos != 'absolute' && elemPos != 'fixed') {
	...
	offsetLite: function(options, returnObject) {
		var x = 0, y = 0, sl = 0, st = 0, parent = this[0], op, 
		    options = jQuery.extend({ margin: true, border: false, padding: false, scroll: true }, options || {});
