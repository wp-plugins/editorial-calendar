...
<div class="wrap">
    ...
    <div id="topbar">
        <div id="topleft">
            <h3><a href="#" class="prev page-numbers" id="prevmonth" style="border: none";>&laquo;</a><span id="currentRange"></span><a href="#" class="next page-numbers" id="nextmonth" style="border: none";>&raquo;</a></h2> <span id="loading"> </span>
        </div>
        <div id="topright">
